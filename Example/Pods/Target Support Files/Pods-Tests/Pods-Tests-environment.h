...
// PageSlider
#define COCOAPODS_POD_AVAILABLE_PageSlider
#define COCOAPODS_VERSION_MAJOR_PageSlider 0
#define COCOAPODS_VERSION_MINOR_PageSlider 1
#define COCOAPODS_VERSION_PATCH_PageSlider 0
